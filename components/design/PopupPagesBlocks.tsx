        ...
        <div onMouseEnter={() => setPopup({ ...popup, mouse: true })} onMouseLeave={() => setPopup({ ...popup, mouse: false })} className={`${popup.opacity === 'opacity-1' ? 'scale-100' : 'scale-90'} transition-transform duration-200 p-8 bg-white h-[550px] m-auto rounded-xl border w-[810px] flex flex-col gap-4 shadow-popup dark:shadow-popup-dark dark:bg-neutral-800 dark:border-neutral-700`}>
          ...
          <div className='flex flex-wrap gap-4 overflow-y-auto'>
            ...
            <div onClick={() => {
              ...
              <Image className="border my-auto dark:border-neutral-600" width={397} height={190} draggable='false' alt="Imagen Slider" src='https://upvisor-web-cdn.b-cdn.net/Suscripci%C3%B3n.png' />
            ...
            <div onClick={() => {
              ...
              <Image className="border dark:border-neutral-600" width={450} height={216} draggable='false' alt="Imagen Slider" src='https://upvisor-web-cdn.b-cdn.net/Rese%C3%B1as.png' />
