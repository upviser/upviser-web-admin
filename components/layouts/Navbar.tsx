            ...
            <div className='fixed top-[49px] h-full flex w-full z-50'>
              <div className={`w-[250px] h-full z-50 border-r bg-bg border-border p-4 flex-col justify-between dark:border-neutral-800 dark:bg-neutral-900`}>
                <div className='flex flex-col gap-1'>
                  ...
                  {
                    session?.user.type === 'Administrador' || session?.user.permissions?.includes('Pagos') && session.user.email === ''
                  ...
                  {
                    session?.user.type === 'Administrador' || session?.user.permissions?.includes('Servicios') && session.user.email === ''
                  ...
                  {
                    session?.user.type === 'Administrador' || session?.user.permissions?.includes('Embudos') && session.user.email === ''
                  ...
                  {
                    session?.user.type === 'Administrador' || session?.user.permissions?.includes('CRM') && session.user.email === ''
                  ...
                  {
                    session?.user.type === 'Administrador' || session?.user.permissions?.includes('Campañas') && session.user.email === ''
                  ...
                  {
                    session?.user.type === 'Administrador' || session?.user.permissions?.includes('Automatizaciones') && session.user.email === ''
